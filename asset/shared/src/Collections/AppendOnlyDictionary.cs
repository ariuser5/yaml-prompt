...
/// <summary>
/// Represents a dictionary that allows appending new key-value pairs and updating existing values, but does not allow removal of entries.
/// </summary>
...
public class AppendOnlyDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, TValue> where TKey : notnull
{
    ...
    /// <summary>
    /// Gets or sets the value associated with the specified key. Setting a value will update it if the key exists, or add it if not.
    /// </summary>
